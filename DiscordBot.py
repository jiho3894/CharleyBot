...
def title(msg):
    ...
    chromedriver_dir = r"C:\Users\Jiho\Downloads\chromedriver_win32\chromedriver.exe" #chromedriver.exe 경로 위치
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity= discord.Game("지상에서 음원 제작")) # 활동 상태 문구 수정창
...
bot.run('OTI1MjU3NDM3MjM2MzIyMzk1.YcqfIw.r8aLbdNIv_CqXQqhZpzI7z7_VDQ')
